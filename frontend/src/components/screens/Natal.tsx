        ...
        {houses?.map((h) => {
          ...
          return (
            <line
              ...
              y2={p2.y}
              stroke={
                isAxis ? "rgba(212,178,84,0.25)" : "rgba(212,178,84,0.08)"
              }
          ...
          <>
            ...
            {summaryLoading ? (
              ...
              <>
                ...
                >
                  <NatalWheel
                    sunSign={summary?.sun_sign ?? undefined}
