    ...
    cards: [
      {
        ...
        iconColor: '#c9a84c',
        icon: (
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
      ...
      },
      {
        ...
        screen: 'mac',
        gradient: 'linear-gradient(135deg, rgba(160,125,232,0.12) 0%, rgba(160,125,232,0.03) 100%)',
        iconColor: '#a07de8',
        icon: (
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
    ...
    cards: [
      {
        ...
        gradient: 'linear-gradient(135deg, rgba(197,184,240,0.12) 0%, rgba(197,184,240,0.03) 100%)',
        iconColor: '#c5b8f0',
        icon: (
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
      ...
      },
      {
        ...
        locked: true,
        gradient: 'linear-gradient(135deg, rgba(232,201,126,0.08) 0%, rgba(232,201,126,0.02) 100%)',
        iconColor: '#e8c97e',
        icon: (
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
    ...
    cards: [
      {
        ...
        screen: 'moon',
        gradient: 'linear-gradient(135deg, rgba(197,184,240,0.1) 0%, rgba(100,90,160,0.06) 100%)',
        iconColor: '#c5b8f0',
        icon: (
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
      ...
      },
      {
        ...
        locked: true,
        gradient: 'linear-gradient(135deg, rgba(158,154,181,0.1) 0%, rgba(158,154,181,0.02) 100%)',
        iconColor: '#9e9ab5',
        icon: (
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
    ...
    cards: [
      {
        ...
        locked: true,
        gradient: 'linear-gradient(135deg, rgba(139,200,155,0.1) 0%, rgba(139,200,155,0.02) 100%)',
        iconColor: '#8bc89b',
        icon: (
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
            ...
            <circle cx="22" cy="7" r="3" fill="rgba(201,168,76,0.5)" stroke="none"/>
          </svg>
        ),
      },
      {
        ...
        locked: true,
        gradient: 'linear-gradient(135deg, rgba(126,200,227,0.1) 0%, rgba(126,200,227,0.02) 100%)',
        iconColor: '#7ec8e3',
        icon: (
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
