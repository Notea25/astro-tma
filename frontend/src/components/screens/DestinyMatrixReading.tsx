...
const NODE_TITLES_RU: Record<DestinyNodeId, string> = {
  ...
  // Cardinal axis: 3 dots from corner toward center (1, 2, 3)
  ...
  // Diagonals: 3 dots from corner toward center
  aft_1: "Род отца · таланты — точка 1",
  aft_2: "Род отца · таланты — точка 2",
  aft_3: "Род отца · таланты — точка 3",
