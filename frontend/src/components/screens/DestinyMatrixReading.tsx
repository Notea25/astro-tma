        ...
        {reading && (
          <>
            ...
            {!reading.has_full_access && (
              <>
                ...
                <section className="destiny-reading__upsell">
                  ...
                  <p>
                    Личный разбор из 20 разделов: визитка, дерево рода, кармический
              ...
              <>
                ...
                <section className="destiny-reading__pdf">
                  ...
                  <p>
                    ...
                    в 20 разделах. Можно перечитать позже.
                  </p>
                  <button
                    type="button"
                    className="btn-stars"
            ...
            <p className="interpretation-disclaimer" role="note">
              Матрица — развлекательная символическая интерпретация, не
