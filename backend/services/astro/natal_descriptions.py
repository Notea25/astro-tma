...
- "short" (4-5 предложений, ~80-120 слов): что эта планета в данном знаке и доме значит для человека — как проявляется в характере и в жизни, на что обратить внимание.
- "full" (6-9 предложений, ~150-220 слов): тот же разбор подробнее — характер, мотивации, что даётся легко, где приходится работать; обязательно разверни тему дома (какая сфера жизни активируется).
