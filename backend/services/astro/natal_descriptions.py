...
- "short" — компактное описание (2 предложения, ~25-40 слов): что эта планета в данном знаке означает для человека — характер, проявления в жизни, на что обратить внимание; дом упомяни только одним прикладным штрихом.
- "full" — компактное полное описание (1-2 абзаца, ~90-130 слов): центр разбора — связка планета + знак; раскрой характер, мотивации, сильные стороны, потенциальные сложности и бытовые проявления. Дом используй только в финальном предложении как персональное уточнение, не делай его главной темой.
...
- "short" — компактное описание (2 предложения, ~25-40 слов): какую сферу жизни описывает этот дом, как знак на куспиде окрашивает её, ключевые проявления.
- "full" — компактное полное описание (3-4 предложения, ~50-80 слов): тема дома, что говорит знак на куспиде о вашем подходе к этой сфере, проявления в характере и жизненных ситуациях, сильные стороны, на что обратить внимание.
...
- "short" — компактное описание (2 предложения, ~25-40 слов): как эти две планеты взаимодействуют, что человеку даёт или с чем приходится работать.
- "full" — компактное полное описание (3-4 предложения, ~50-80 слов): как именно эти две планеты взаимодействуют, гармония это или напряжение, какие сферы жизни затронуты, как проявляется в характере и ситуациях, сильные стороны и зоны роста.
...
- "short" (2 предложения, ~25-40 слов): что эта планета в данном знаке значит для человека — как проявляется в характере и в жизни, на что обратить внимание; дом упомяни только одним прикладным штрихом.
- "full" (1-2 абзаца, ~90-130 слов): компактный справочный текст как в классическом описании «планета в знаке»: характер, мотивации, сильные стороны, уязвимости, отношения, работа/дела, привычки и бытовые проявления. Дом добавь только в финальном предложении как персональный акцент.
...
Вызови инструмент submit_entry с двумя полями:
- "short" (2 предложения, ~25-40 слов): какую сферу жизни описывает этот дом, как знак на куспиде её окрашивает, ключевые проявления.
- "full" (3-4 предложения, ~50-80 слов): тема дома подробнее, что говорит знак о подходе к этой сфере, как это видно в характере и поведении, сильные стороны и точки роста.
...
Вызови инструмент submit_entry с двумя полями:
- "short" (2 предложения, ~25-40 слов): как эти две темы взаимодействуют — что даёт человеку или с чем приходится работать.
- "full" (3-4 предложения, ~50-80 слов): как именно сочетаются эти две темы, гармония это или трение, какие сферы жизни затронуты, как проявляется в характере и поведении, сильные стороны и точки роста.
