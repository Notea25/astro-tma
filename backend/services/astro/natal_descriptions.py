...
- "full" — масштабное полноценное описание (3-4 абзаца, ~180-240 слов): тема дома, стиль знака на куспиде, типичные жизненные сценарии, как это видно в характере и поведении, отношения, работа/дела или быт этой сферы, сильная сторона, точка внимания и практический ориентир.
...
- "full" (3-4 абзаца, ~180-240 слов): тема дома подробнее, стиль знака на куспиде, типичные жизненные сценарии, как это видно в характере и поведении, отношения, работа/дела или быт этой сферы, сильная сторона, точка внимания и практический ориентир.
...
- "full" (3-4 абзаца, ~220-300 слов): как именно сочетаются эти две темы, гармония это или трение, какие сферы жизни затронуты, как проявляется в характере, отношениях/делах, привычных реакциях и повторяющихся ситуациях, сильные стороны, зоны роста и практический способ проживать аспект мягче.
