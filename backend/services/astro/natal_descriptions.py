...
Вызови инструмент submit_planet_descriptions, передав описания для всех перечисленных выше планет."""
...
Вызови инструмент submit_house_descriptions, передав описания для всех перечисленных выше домов. Ключи — номера домов как строки («1», «2», …)."""
...
Вызови инструмент submit_aspect_descriptions, передав массив items с описаниями для всех аспектов из списка выше. Для каждого элемента указывай "id" в формате "<планета1>_<планета2>_<аспект>" — точно так же, как в списке."""
