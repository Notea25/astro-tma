...
_RIDER_WAITE_TO_CANON: dict[str, tuple[int, str]] = {
    ...
    "Колесница":       (7,  "Воин"),
    "Суд":             (20, "Ясно знание"),
    # ── Genitive («Год Луны», «энергия Шута», «без Дьявола») ──
    # Replacement string preserves grammatical case so the surrounding
    # prose still reads naturally («Год Магии», «энергия Уровневой свободы»).
