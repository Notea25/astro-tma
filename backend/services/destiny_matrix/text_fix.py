...
_RIDER_WAITE_TO_CANON: dict[str, tuple[int, str]] = {
    ...
    #
    # NOTE: «Солнце» / «Звезда» также НЕ в этом списке (и никогда не были).
    # Они — канонические имена арканов 19 и 17 у Ладини (она НЕ
    # переименовала их в отличие от Луны→Магии). Совпадение с
    # астрономическим словом намеренное, ничего не нужно фиксить.
