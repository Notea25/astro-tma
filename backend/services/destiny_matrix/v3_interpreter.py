...
def _prompt_karmic_tail(ctx: V3Context) -> tuple[str, int]:
    ...
    return (
        ...
        "ВАЖНО (разведение с канон-страницей): НЕ повторяй список «как "
        "прорабатывать» из канонического описания дословно. Сформулируй 3-4 "
        "практики СВОИМИ словами и привяжи их к конкретным арканам этой "
        f"тройки оси (аркан {bottom_2}, аркан {bottom_1}, аркан {bottom}) — "
        "а не к общей формуле канона. Каноническое описание — опора для "
        "смысла прошлого воплощения, но финальные шаги в твоей секции "
        "должны отличаться от него по формулировкам и ракурсу."
    ), 400
