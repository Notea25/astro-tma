...
SPREADS: dict[str, list[SpreadPosition]] = {
    ...
    "celtic_cross": [
        ...
        SpreadPosition(2, "Подсознание",   "Корни ситуации, подсознательные причины"),
        SpreadPosition(3, "Прошлое",       "Что уходит, прошлые влияния"),
        SpreadPosition(4, "Цели",          "Сознательное, цели, что над головой"),
        SpreadPosition(5, "Будущее",       "Ближайшее будущее, что приходит"),
        SpreadPosition(6, "Отношение",     "Ваше отношение к ситуации"),
        SpreadPosition(7, "Окружение",     "Влияние других людей"),
        SpreadPosition(8, "Надежды",       "Ваши надежды и страхи"),
